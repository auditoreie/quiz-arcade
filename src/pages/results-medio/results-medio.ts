...
// @IonicPage()
@Component({
  selector: 'page-results-medio',
  templateUrl: 'results-medio.html',
})
export class ResultsMedioPage {
  results: any;
  quizTotal: number;
  correctTotal: number;
  nomeAlunoST: any;
  ...
  constructor(
    ...
    private storage: Storage) {
      console.log("Entrei na Pagina Results Medio");
  ...
  backHome() {
    this.navCtrl.setRoot(EnsinoMedioPage);
  }

  restart() {
    this.navCtrl.setRoot(GameViewMedioPage);
